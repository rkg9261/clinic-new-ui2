...
const AppointmentPayment = ({
  ...
  //old code for handlePayNow function is commented out below. It seems like you want to keep it for reference or future use.
  // const handlePayNow = () => {
